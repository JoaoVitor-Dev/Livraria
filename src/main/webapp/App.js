...
function pesquisaTitulo() {
    ...
    ajax(`FiltraTitulo?titulo=${titulo}`, mostrarXML);
}
...
function pesquisaCategoria() {
    ...
    ajax(`FiltraCategoria?categoria=${categoria}`, mostrarXML);
}

function pesquisaAutor() {
    const autor = document.getElementById("autor").value;
    ajax(`FiltraAutor?autor=${autor}`, mostrarXML);
}

function pesquisaAno() {
    const ano = document.getElementById("ano").value;
    const op=document.getElementById("selcAno").value;
    ajax(`FiltraAno?ano=${ano}&operador=${op}`, mostrarXML);
}
